...
_.falsyOrTruthy = function(a){
  ...
  _.ifLogic = function(a, b){
    ...
    //While looping through the array passed determine the data type of the element.
    //  If the element is a number add it to a variable. At the end return that variable. 
    ...
    //This function is similar to the above function. Only this time you will be building a sentence 
    // rather than a total number. Loop through the array and concatenate the strings in it to make a sentence.
    ...
    //In this function you will loop though the passed in array. Prior to that you need to check the
    //  second parameter to determine what you will be returning. 
    //If the second parameter is 'string' return a sentence created using the strings in the array.
    //  If the second parameter is 'number' you will return the total of the number in the array. 
    //You may notice you did this work already in previous functions but need to combine them in some way.
    //  Ideally, you should call the previous two functions in your implementation instead of copy/pasting the 'guts'.
